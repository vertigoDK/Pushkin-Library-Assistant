...
class AnyzLegendParser:
    ...
    async def _extract_text_from_legend(self, legend_link: str, class_for_div: str = "elementor-widget-wrap elementor-element-populated") -> str:
        async with async_playwright() as p:
            browser = await p.chromium.launch(headless=False)  # Можно использовать .launch(headless=False) для отображения браузера
