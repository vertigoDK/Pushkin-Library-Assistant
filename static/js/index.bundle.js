    ...
    i.m = e, i.n = function (e) {
        ...
        function k(e) {
            return void 0 === e && (e = {}), C || (C = function (e) {
                ...
                const i = L(), s = a(), r = s.navigator.platform, n = t || s.navigator.userAgent,
        ...
        var G = {
            updateSize: function () {
                ...
                for (let s = 0; s < p; s += 1) {
                    let r;
                    if (P = 0, c[s] && (r = c[s]), C && e.grid.updateSlide(s, r, c), !c[s] || "none" !== y(r, "display")) {
                        if ("auto" === i.slidesPerView) {
                            L && (c[s].style[e.getDirectionLabel("width")] = "");
                            const n = getComputedStyle(r), a = r.style.transform, o = r.style.webkitTransform;
                            if (a && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), i.roundLengths) P = e.isHorizontal() ? T(r, "width", !0) : T(r, "height", !0); else {
                                ...
                                if (l && "border-box" === l) P = e + a + o; else {
                                    const {clientWidth: t, offsetWidth: n} = r;
                                    P = e + i + s + a + o + (n - t)
                                }
                            }
                            a && (r.style.transform = a), o && (r.style.webkitTransform = o), i.roundLengths && (P = Math.floor(P))
                        } else P = (n - (i.slidesPerView - 1) * E) / i.slidesPerView, i.roundLengths && (P = Math.floor(P)), c[s] && (c[s].style[e.getDirectionLabel("width")] = `${P}px`);
                        c[s] && (c[s].swiperSlideSize = P), h.push(P), i.centeredSlides ? (S = S + P / 2 + A / 2 + E, 0 === A && 0 !== s && (S = S - n / 2 - E), 0 === s && (S = S - n / 2 - E), Math.abs(S) < .001 && (S = 0), i.roundLengths && (S = Math.floor(S)), M % i.slidesPerGroup == 0 && u.push(S), f.push(S)) : (i.roundLengths && (S = Math.floor(S)), (M - Math.min(e.params.slidesPerGroupSkip, M)) % e.params.slidesPerGroup == 0 && u.push(S), f.push(S), S = S + P + E), e.virtualSize += P + E, A = P, M += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, n) + w, a && o && ("slide" === i.effect || "coverflow" === i.effect) && (s.style.width = `${e.virtualSize + E}px`), i.setWrapperSize && (s.style[e.getDirectionLabel("width")] = `${e.virtualSize + E}px`), C && e.grid.updateWrapperSize(P, u), !i.centeredSlides) {
                    const t = [];
        ...
        var N = {
            ...
            loopCreate: function (e) {
                ...
                const C = b ? Math.ceil(d.length / m.grid.rows) : d.length,
                    P = (b ? d[n].column : n) + (f && void 0 === r ? -h / 2 + .5 : 0);
                if (P < w) {
                    A = Math.max(w - P, g);
        ...
        const Z = (e, t) => {
            ...
            n && "string" != typeof n && (i[d]("touchstart", e.onDocumentTouchStart, {
                ...
                passive: !1,
                capture: l
            }), i[d]("touchend", e.onTouchEnd, {passive: !0}), i[d]("pointerup", e.onTouchEnd, {passive: !0}), i[d]("pointercancel", e.onTouchEnd, {passive: !0}), i[d]("touchcancel", e.onTouchEnd, {passive: !0}), i[d]("pointerout", e.onTouchEnd, {passive: !0}), i[d]("pointerleave", e.onTouchEnd, {passive: !0}), i[d]("contextmenu", e.onTouchEnd, {passive: !0}), (s.preventClicks || s.preventClicksPropagation) && n[d]("click", e.onClick, !0), s.cssMode && a[d]("scroll", e.onScroll), s.updateOnWindowResize ? e[c](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", H, !0) : e[c]("observerUpdate", H, !0), n[d]("load", e.onLoad, {capture: !0}))
        ...
        const ee = {
            eventsEmitter: z, update: G, translate: {
                ...
                setTransition: function (e, t) {
                    ...
                    s.cssMode || (s.autoHeight && i.updateAutoHeight(), Y({
                        swiper: i,
                        runCallbacks: e,
                        direction: t,
                        step: "Start"
                    ...
                    void 0 === e && (e = !0);
                    const i = this, {params: s} = i;
                    i.animating = !1, s.cssMode || (i.setTransition(0), Y({
                        swiper: i,
                        runCallbacks: e,
                        direction: t,
                        step: "End"
                ...
                attachEvents: function () {
                    ...
                    e.onTouchStart = F.bind(e), e.onTouchMove = q.bind(e), e.onTouchEnd = j.bind(e), e.onDocumentTouchStart = U.bind(e), t.cssMode && (e.onScroll = V.bind(e)), e.onClick = X.bind(e), e.onLoad = W.bind(e), Z(e, "on")
        ...
        class ie {
            constructor() {
                ...
                const l = this;
                l.__swiper__ = !0, l.support = L(), l.device = k({userAgent: t.userAgent}), l.browser = (P || (P = function () {
                    const e = a(), t = k();
                    let i = !1;
        ...
        const fe = [function (e) {
            ...
            function c(e, t) {
                ...
                const L = o ? -f.length : 0, k = o ? 2 * f.length : f.length;
                for (let t = L; t < k; t += 1) if (t >= E && t <= S) {
                    const i = P(t);
            ...
            function k(e) {
                ...
                let r, a, o, l, c, p, u, h, v, w, y, S, T, A, M, C, P, L;
                ...
                const z = x();
                i.scale = k || z, d = k || z, !e || 1 === d && k ? (u = 0, h = 0) : (P = m.slideEl.offsetWidth, L = m.slideEl.offsetHeight, o = b(m.slideEl).left + n.scrollX, l = b(m.slideEl).top + n.scrollY, c = o + P / 2 - r, p = l + L / 2 - a, v = m.imageEl.offsetWidth || m.imageEl.clientWidth, w = m.imageEl.offsetHeight || m.imageEl.clientHeight, y = v * i.scale, S = w * i.scale, T = Math.min(P / 2 - y / 2, 0), A = Math.min(L / 2 - S / 2, 0), M = -T, C = -A, u = c * i.scale, h = p * i.scale, u < T && (u = T), u > M && (u = M), h < A && (h = A), h > C && (h = C)), k && 1 === i.scale && (m.originX = 0, m.originY = 0), m.imageWrapEl.style.transitionDuration = "300ms", m.imageWrapEl.style.transform = `translate3d(${u}px, ${h}px,0)`, m.imageEl.style.transitionDuration = "300ms", m.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`
            }
            ...
            function D() {
                ...
                })), t.wrapperEl.addEventListener("pointermove", P, s)
            }
            ...
            function $() {
                ...
                })), t.wrapperEl.removeEventListener("pointermove", P, s)
            }
            ...
            a("init", (() => {
                s.params.autoplay.enabled && (s.params.autoplay.pauseOnMouseEnter && (s.el.addEventListener("pointerenter", P), s.el.addEventListener("pointerleave", L)), r().addEventListener("visibilitychange", C), S())
            })), a("destroy", (() => {
                s.el && "string" != typeof s.el && (s.el.removeEventListener("pointerenter", P), s.el.removeEventListener("pointerleave", L)), r().removeEventListener("visibilitychange", C), s.autoplay.running && T()
        ...
        var he = i(379), ge = i.n(he), ve = i(795), we = i.n(ve), be = i(569), ye = i.n(be), xe = i(565), Ee = i.n(xe),
            Se = i(216), Te = i.n(Se), Ae = i(589), Me = i.n(Ae), Ce = i(541), Pe = {};
        Pe.styleTagTransform = Me(), Pe.setAttributes = Ee(), Pe.insert = ye().bind(null, "head"), Pe.domAPI = we(), Pe.insertStyleElement = Te(), ge()(Ce.Z, Pe), Ce.Z && Ce.Z.locals && Ce.Z.locals;
        var Le = function (e) {
            ...
            if (void 0 === t && (t = document), e instanceof Array) return e.filter(Le);
            if (Le(e)) return [e];
            if (i = e, s = Object.prototype.toString.call(i), "object" == typeof window.NodeList ? i instanceof window.NodeList : null !== i && "object" == typeof i && "number" == typeof i.length && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(s) && (0 === i.length || Le(i[0]))) return Array.prototype.slice.call(e);
            var i, s;
        ...
        var Be, Ge = (Be = Date.now(), function (e) {
                var t = Date.now();
                t - Be > 16 ? (Be = t, e(t)) : setTimeout((function () {
                    return Ge(e)
                }), 0)
            }),
            Ye = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || Ge,
            Ne = {
                delay: 0,
                distance: "0",
                duration: 600,
        ...
        function Ue(e) {
            ...
            try {
                ...
                return je.call(this, "Clean failed.", e.message)
            }
            if (t) try {
                He.call(this)
            } catch (e) {
        ...
        function tt() {
            var e = this;
            He.call(this), qe(this.store.elements, (function (e) {
        ...
        function ct(e, t, i) {
            ...
            try {
                ...
                return je.call(this, "Reveal failed.", e.message)
            }
            qe(n, (function (e) {
        ...
        function Tt(e, t) {
            var i = this;
            void 0 === e && (e = {type: "init"}), void 0 === t && (t = this.store.elements), Ye((function () {
        ...
        function At(e) {
            ...
            if (!At.isSupported()) return je.call(this, "Instantiation failed.", "This browser is not supported."), Re();
            try {
                t = Qe({}, vt || Ne, e)
            } catch (e) {
                return je.call(this, "Invalid configuration.", e.message), Re()
            }
            try {
                if (!ke(t.container)[0]) throw new Error("Invalid container.")
            } catch (e) {
                return je.call(this, e.message), Re()
            }
            return !(vt = t).mobile && Ke() || !vt.desktop && !Ke() ? (je.call(this, "This device is disabled.", "desktop: " + vt.desktop, "mobile: " + vt.mobile), Re()) : (_e(), this.store = {
                containers: {},
                elements: {},
                history: [],
                sequences: {}
        ...
        !function () {
            ...
            function n() {
                for (let e = 0; e < t.length; e++) t[e].src = `/static/img/tour/${r.id}-${e + 1}.jpg`
            }
            ...
            const e = document.querySelector(".dosai-fixed__chat-box"),
                ...
                n = document.querySelector("#dosai-fixed-img-1"), a = document.querySelector("#dosai-fixed-img-2");

            function o() {
                !function (t) {
                    let i = t.split(""), s = 25, r = "";
                    for (let e = 0; e < i.length; e++) r += i[e], e === s && (r += `\n${i[e]}`, s += 25);
                    const n = document.createElement("div");
                    n.textContent = r, n.classList.add("dosai__user-msg"), e.appendChild(n)
                }(s.value), s.value = "", i.style.height = "49px", s.rows = 1
            }

            s.addEventListener("input", (function () {
                t.style.height = "auto", i.style.height = "auto", this.rows = 2
            })), i.addEventListener("keypress", (function (e) {
                "Enter" === e.key && (e.preventDefault(), "" !== s.value && o())
            })), i.addEventListener("submit", (function (e) {
                e.preventDefault(), "" !== s.value && o()
            })), r.addEventListener("click", (function () {
                t.classList.toggle("chat-shown"), n.classList.toggle("chat-shown"), a.classList.toggle("chat-shown")
            }))
        }(), new ie(".hero__swiper", {
            slidesPerView: 1,
            loop: !0,
