            ...
            if (!this.__initialized) {
                this.__releaseCallbacks = [], this.__propertyChangedCallbacks = [], this.__updating = {}, this.props = function (s, n) {
                    ...
                    return Object.keys(n).forEach((t => {
                        const n = o[t], i = s.getAttribute(n.attribute), a = s[t];
                ...
                }(this.props), i = this.Component, a = n;
                try {
                    (n = this).__initialized = !0, function (t) {
                        return "function" == typeof t && 0 === t.toString().indexOf("class")
                    }(i) ? new i(s, {element: this}) : i(s, {element: this})
                } finally {
                    n = a
                }
            }
    ...
    return r => {
        ...
        return a ? a.prototype.Component = r : ((a = o(n, function (t) {
            return t ? Object.keys(t).reduce(((e, r) => {
                var n = t[r];
                return e[r] = s(n) && "value" in n ? n : {value: n}, e[r].attribute || (e[r].attribute = function (t) {
...
const a = Symbol("solid-proxy"), l = Symbol("solid-track"), c = {equals: (t, e) => t === e};
let h = L;
const u = 1, p = 2, d = {owned: null, cleanups: null, context: null, owner: null};
var f = null;
let g = null, b = null, y = null, m = null, v = 0;

function w(t, e) {
    const r = b, s = f, n = 0 === t.length,
        o = n ? d : {owned: null, cleanups: null, context: null, owner: void 0 === e ? s : e},
        i = n ? t : () => t((() => S((() => M(o)))));
    f = o, b = null;
    try {
        return B(i, !0)
...
function _(t, e, r) {
    h = j, (t = $(t, e, !1, u)).user = !0, m ? m.push(t) : R(t)
}

function C(t, e, r) {
    return r = r ? Object.assign({}, c, r) : c, (t = $(t, e, !0, 0)).observers = null, t.observerSlots = null, t.comparator = r.equals || void 0, R(t), E.bind(t)
}
...
function P(t, e, r) {
    ...
    return t.comparator && t.comparator(s, e) || (t.value = e, t.observers && t.observers.length && B((() => {
        for (let s = 0; s < t.observers.length; s += 1) {
            var e = t.observers[s], r = g && g.running;
...
function T(t) {
    if (0 !== t.state) {
        ...
        for (let s = r.length - 1; 0 <= s; s--) {
            var e;
            (t = r[s]).state === u ? R(t) : t.state === p && (e = y, y = null, B((() => N(t, r[0])), !1), y = e)
        }
    }
}
...
function W(...t) {
    ...
    var s = {};
    for (let e = t.length - 1; 0 <= e; e--) if (t[e]) for (const r in Object.getOwnPropertyDescriptors(t[e])) r in s || Object.defineProperty(s, r, {
        enumerable: !0,
        get() {
            for (let s = t.length - 1; 0 <= s; s--) {
                var e = (t[s] || {})[r];
...
function V(t, ...e) {
    ...
    return e.push(Object.keys(n).filter((t => !r.has(t)))), e.map((e => {
        ...
        for (let s = 0; s < e.length; s++) {
            const o = e[s];
            o in t && Object.defineProperty(r, o, n[o] || {get: () => t[o], set: () => !0, enumerable: !0})
        }
        return r
    }))
}
...
function Y(t) {
    ...
    return C(function (t, e, r = {}) {
        let s = [], n = [], o = [], i = 0, a = 1 < e.length ? [] : null;
        return O((() => D(o))), () => {
            let c, h, u = t() || [];
            return u[l], S((() => {
                let t, e, l, d, f, g, b, y, m, v = u.length;
                if (0 === v) 0 !== i && (D(o), o = [], s = [], n = [], i = 0, a = a && []), r.fallback && (s = [q], n[0] = w((t => (o[0] = t, r.fallback()))), i = 1); else if (0 === i) {
...
function X(t) {
    const e = t.keyed, r = C((() => t.when), void 0, {equals: (t, r) => e ? t === r : !t == !r});
    return C((() => {
        const s = r();
        if (s) {
            const n = t.children;
...
const K = new Set(["className", "value", "readOnly", "formNoValidate", "isMap", "noModule", "playsInline", "allowfullscreen", "async", "autofocus", "autoplay", "checked", "controls", "default", "disabled", "formnovalidate", "hidden", "indeterminate", "ismap", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "seamless", "selected"]),
    ...
    Q = Object.assign(Object.create(null), {className: "class", htmlFor: "for"}),
...
const tt = new Set(["beforeinput", "click", "dblclick", "contextmenu", "focusin", "focusout", "input", "keydown", "keyup", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "pointerdown", "pointermove", "pointerout", "pointerover", "pointerup", "touchend", "touchmove", "touchstart"]),
    et = {xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace"};
...
function ut(t, e, r, s, n, o) {
    ...
    return "style" === e ? function (t, e, r) {
        ...
        var s = Object.keys(e || {}), n = Object.keys(r);
        let o, i;
        ...
        if (s) Array.isArray(r) ? (t["$$" + e] = r[0], t[`$$${e}Data`] = r[1]) : t["$$" + e] = r; else if (Array.isArray(r)) {
            const s = r[0];
...
function pt(t) {
    ...
    for (t.target !== r && Object.defineProperty(t, "target", {
        configurable: !0,
        value: r
    }), Object.defineProperty(t, "currentTarget", {configurable: !0, get: () => r || document}); r;) {
        var s = r[e];
        if (s && !r.disabled) {
            var n = r[e + "Data"];
...
function dt(t, e, r, s, n) {
    ...
    if (e !== r) {
        var o = typeof e, i = void 0 !== s;
        if (t = i && r[0] && r[0].parentNode || t, "string" == o || "number" == o) if ("number" == o && (e = e.toString()), i) {
            let n = r[0];
            n && 3 === n.nodeType ? n.data = e : n = document.createTextNode(e), r = bt(t, r, s, n)
        } else r = "" !== r && "string" == typeof r ? t.firstChild.data = e : t.textContent = e; else if (null == e || "boolean" == o) r = bt(t, r, s); else {
            ...
            if (Array.isArray(e)) {
                ...
                if (0 === a.length) {
                    ...
                    let s = r.length, n = e.length, o = s, i = 0, a = 0, l = e[n - 1].nextSibling, c = null;
                    for (; i < n || a < o;) if (e[i] === r[a]) i++, a++; else {
                        for (; e[n - 1] === r[o - 1];) n--, o--;
                        if (n === i) for (var h = o < s ? a ? r[a - 1].nextSibling : r[o - a] : l; a < o;) t.insertBefore(r[a++], h); else if (o === a) for (; i < n;) c && c.has(e[i]) || e[i].remove(), i++; else if (e[i] === r[o - 1] && r[a] === e[n - 1]) {
                            ...
                            var p = c.get(e[i]);
                            if (null != p) if (a < p && p < o) {
                                let s, l = i, h = 1;
                                for (; ++l < n && l < o && null != (s = c.get(e[l])) && s === p + h;) h++;
                                if (h > p - a) for (var d = e[i]; a < p;) t.insertBefore(r[a++], d); else t.replaceChild(r[a++], e[i++])
                            } else i++; else e[i++].remove()
                        }
                    }
                }(t, r, a) : (r && bt(t), gt(t, a));
                r = a
...
function ft(t, e, r, s) {
    ...
    for (let i = 0, a = e.length; i < a; i++) {
        let a = e[i], l = r && r[i];
        if (a instanceof Node) t.push(a); else if (null != a && !0 !== a && !1 !== a) if (Array.isArray(a)) n = ft(t, a, l) || n; else if ("function" == typeof a) if (s) {
            for (; "function" == typeof a;) a = a();
            n = ft(t, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || n
        } else t.push(a), n = !0; else {
            var o = String(a);
...
const _t = t => null == t, Ct = t => null != t, St = async t => {
    ...
    At = st('<svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z">'),
    Ot = st('<img alt="Bubble button icon">'),
    Et = st('<button part="button"><svg viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.601 8.39897C18.269 8.06702 17.7309 8.06702 17.3989 8.39897L12 13.7979L6.60099 8.39897C6.26904 8.06702 5.73086 8.06702 5.39891 8.39897C5.06696 8.73091 5.06696 9.2691 5.39891 9.60105L11.3989 15.601C11.7309 15.933 12.269 15.933 12.601 15.601L18.601 9.60105C18.9329 9.2691 18.9329 8.73091 18.601 8.39897Z">'),
    Pt = t => {
        {
            const e = Et(), r = e.firstChild;
            return e.$$click = () => t.toggleBot(), e.style.setProperty("z-index", "42424242"), ct(e, F(X, {
                ...
                var n = "fixed shadow-md rounded-full hover:scale-110 active:scale-95 transition-transform duration-200 flex justify-center items-center animate-fade-in" + ("large" === t.size ? " w-16 h-16" : " w-12 h-12"),
                    o = t.backgroundColor ?? "#3B81F6", i = t.right ? t.right.toString() + "px" : "20px",
                    a = t.bottom ? t.bottom.toString() + "px" : "20px", l = t.iconColor ?? "white",
            ...
            }), {_v$5: void 0, _v$6: void 0, _v$7: void 0, _v$8: void 0, _v$9: void 0, _v$10: void 0}), e
        }
    }, Rt = (nt(["click"]), ({chatflowid: t, apiHost: e = "http://localhost:3000", body: r}) => St({
        method: "POST",
        url: e + "/api/v1/prediction/" + t,
        body: r
    })), $t = st('<input class="focus:outline-none bg-transparent px-4 py-4 flex-1 w-full text-input" type="text">'),
    Tt = t => {
        const [e, r] = V(t, ["ref", "onInput"]);
        return (s = $t()).$$input = t => e.onInput(t.currentTarget.value), "function" == typeof (n = t.ref) ? lt(n, s) : t.ref = s, at(s, W({
            get style() {
    ...
    Nt = st('<svg><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">'),
    zt = t => {
        return at(e = jt(), W({
            get disabled() {
        ...
        return at(e = Nt(), W(t, {
            ...
            }, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", "data-testid": "loading-spinner"
        }), !0, !0), e;
        var e
    }, [It, qt] = x(), Dt = st("<span>Send"),
    Ft = st('<div class="flex items-end justify-between chatbot-input" data-testid="input">'), Gt = t => {
        ...
        }));
        {
            ...
            return r.$$keydown = i, r.style.setProperty("border-top", "1px solid #eeeeee"), r.style.setProperty("position", "absolute"), r.style.setProperty("left", "20px"), r.style.setProperty("right", "20px"), r.style.setProperty("bottom", "40px"), r.style.setProperty("margin", "auto"), r.style.setProperty("z-index", "1000"), ct(r, F(Tt, {
                ...
                get sendButtonColor() {
                    return t.sendButtonColor
                }, type: "button", get isDisabled() {
                    return "" === e()
                }, class: "my-2 ml-2", "on:click": o, get children() {
                    var t = Dt();
                    return t.style.setProperty("font-family", "Poppins, sans-serif"), t
                }
            }), null), k((e => {
                var s = t.backgroundColor ?? "#ffffff", n = t.textColor ?? "#303235";
    ...
    Ut = () => {
    ...
    }, Wt = st('<figure><img alt="Bot avatar" class="rounded-full object-cover w-full h-full">'), Vt = t => {
        ...
        return _((() => {
            ...
            get when() {
                return (t => null != t && "" !== t)(e())
            }, keyed: !0, get fallback() {
                return F(Ut, {})
            }, get children() {
                const t = Wt(), r = t.firstChild;
                return k((s => {
...
class ne {
    ...
    output(t) {
        let e, r = "";
        for (; t;) if (e = this.rules.escape.exec(t)) t = t.substring(e[0].length), r += e[1]; else if (e = this.rules.autolink.exec(t)) {
            let s, n;
...
class oe {
    ...
    parseText() {
        ...
        for (var e; (e = this.getNextElement()) && e.type == wt.text;) t += "\n" + this.next().text;
        ...
        switch (this.token.type) {
            ...
            case wt.table: {
                ...
                for (let t = 0; t < this.token.header.length; t++) {
                    var e = {header: !0, align: this.token.align[t]}, r = this.inlineLexer.output(this.token.header[t]);
            ...
            default:
                if (this.simpleRenderers.length) for (let t = 0; t < this.simpleRenderers.length; t++) if (this.token.type == "simpleRule" + (t + 1)) return this.simpleRenderers[t].call(this.renderer, this.token.execArr);
...
class ae {
    ...
    getTokens(t, e, r) {
        let s, n = t;
        t:for (; n;) if ((s = this.rules.newline.exec(n)) && (n = n.substring(s[0].length), 1 < s[0].length) && this.tokens.push({type: wt.space}), s = this.rules.code.exec(n)) {
            n = n.substring(s[0].length);
            var o = s[0].replace(/^ {4}/gm, "");
            this.tokens.push({type: wt.code, text: this.options.pedantic ? o : o.replace(/\n+$/, "")})
            ...
            depth: "=" === s[2] ? 1 : 2,
            text: s[1]
        }); else if (s = this.rules.hr.exec(n)) n = n.substring(s[0].length), this.tokens.push({type: wt.hr}); else if (s = this.rules.blockquote.exec(n)) n = n.substring(s[0].length), this.tokens.push({type: wt.blockquoteStart}), o = s[0].replace(/^ *> ?/gm, ""), this.getTokens(o), this.tokens.push({type: wt.blockquoteEnd}); else if (s = this.rules.list.exec(n)) {
            n = n.substring(s[0].length);
            var l, c = s[2],
                h = (this.tokens.push({type: wt.listStart, ordered: 1 < c.length}), s[0].match(this.rules.item)),
                u = h.length;
            let t, e = !1;
            for (let s = 0; s < u; s++) {
                let o = h[s];
                l = o.length, -1 !== (o = o.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") && (l -= o.length, o = this.options.pedantic ? o.replace(/^ {1,4}/gm, "") : o.replace(new RegExp("^ {1," + l + "}", "gm"), "")), !this.options.smartLists || s === u - 1 || c === (l = this.staticThis.getRulesBase().bullet.exec(h[s + 1])[0]) || 1 < c.length && 1 < l.length || (n = h.slice(s + 1).join("\n") + n, s = u - 1), t = e || /\n\n(?!\s*$)/.test(o), s !== u - 1 && (e = "\n" === o.charAt(o.length - 1), t = t || e), this.tokens.push({type: t ? wt.looseItemStart : wt.listItemStart}), this.getTokens(o, !1, r), this.tokens.push({type: wt.listItemEnd})
            }
            ...
            if (this.staticThis.simpleRules.length) {
                ...
                for (let t = 0; t < g.length; t++) if (s = g[t].exec(n)) {
                    n = n.substring(s[0].length);
...
const le = st('<div class="dosai__bot-msg flex justify-end mb-2 items-end guest-container dosai__user-msg  "><span class="px-4 py-2 mr-2 whitespace-pre-wrap max-w-full chatbot-guest-bubble" data-testid="guest-bubble">'),
    ce = (ie.setOptions({isNoP: !0}), t => {
        let e;
        A((() => {
            e && (e.innerHTML = ie.parse(t.message))
        }));
        {
            const r = le(), s = r.firstChild;
            ...
            return "function" == typeof e ? lt(e, s) : e = s, s.style.setProperty("border-radius", "6px"), ct(r, F(X, {
                ...
                var r = t.backgroundColor ?? "#3B81F6", n = t.textColor ?? "#ffffff";
    ...
    ue = (ie.setOptions({isNoP: !0}), t => {
        let e;
        A((() => {
            e && (e.innerHTML = ie.parse(t.message))
        }));
        {
            const r = he(), s = r.firstChild;
            ...
            return "function" == typeof e ? lt(e, s) : e = s, s.style.setProperty("border-radius", "6px"), k((e => {
                var r = t.backgroundColor ?? "#f7f8ff", n = t.textColor ?? "#303235";
                return r !== e._v$ && (null != (e._v$ = r) ? s.style.setProperty("background-color", r) : s.style.removeProperty("background-color")), n !== e._v$2 && (null != (e._v$2 = n) ? s.style.setProperty("color", n) : s.style.removeProperty("color")), e
            }), {_v$: void 0, _v$2: void 0}), r
        }
    }),
    ...
    ye = t => {
        return r = (e = be()).firstChild, e.$$click = () => t.onSourceClick?.(), r.style.setProperty("width", "80px"), r.style.setProperty("font-size", "13px"), r.style.setProperty("border-radius", "15px"), r.style.setProperty("cursor", "pointer"), r.style.setProperty("text-overflow", "ellipsis"), r.style.setProperty("overflow", "hidden"), r.style.setProperty("white-space", "nowrap"), ct(r, (() => t.pageContent)), e;
        var e, r
    },
    me = (nt(["click"]), st('<span>Powered by<a href="https://flowiseai.com" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> Flowise')),
    ve = "#303235", we = t => {
        let e, r;
        const s = r => {
            r.forEach((r => {
        ...
        {
            const r = me(), s = r.firstChild.nextSibling;
            ...
            return "function" == typeof e ? lt(e, s) : e = s, s.style.setProperty("font-weight", "bold"), k((e => {
                var n = t.poweredByTextColor ?? ve, o = t.badgeBackgroundColor ?? "#ffffff", i = t.poweredByTextColor ?? ve;
            ...
            }), {_v$: void 0, _v$2: void 0, _v$3: void 0}), r
        }
    ...
    Se = "function" == typeof ArrayBuffer, Ae = ({
                                                     type: t,
                                                     data: e
...
const Re = "function" == typeof ArrayBuffer, $e = (t, e) => {
    var r;
    return "string" != typeof t ? {type: "message", data: Be(t, e)} : "b" === (r = t.charAt(0)) ? {
        type: "message",
        data: Te(t.substring(1), e)
    } : ke[r] ? 1 < t.length ? {type: ke[r], data: t.substring(1)} : {type: ke[r]} : _e
}, Te = (t, e) => {
    var r;
    return Re ? (r = (t => {
        let e, r, s, n, o, i = .75 * t.length, a = t.length, l = 0;
        "=" === t[t.length - 1] && (i--, "=" === t[t.length - 2]) && i--;
        var c = new ArrayBuffer(i), h = new Uint8Array(c);
        ...
        return c
    })(t), Be(r, e)) : {base64: !0, data: t}
}, Be = (t, e) => "blob" === e && t instanceof ArrayBuffer ? new Blob([t]) : t, Le = String.fromCharCode(30);
...
je.prototype.on = je.prototype.addEventListener = function (t, e) {
    ...
    if (this._callbacks = this._callbacks || {}, 0 == arguments.length) this._callbacks = {}; else {
        var r = this._callbacks["$" + t];
        if (r) if (1 == arguments.length) delete this._callbacks["$" + t]; else {
            for (var s, n = 0; n < r.length; n++) if ((s = r[n]) === e || s.fn === e) {
                r.splice(n, 1);
                break
            }
...
const Me = Ne.setTimeout, Ie = Ne.clearTimeout;
...
class Ge extends je {
    ...
    onData(t) {
        t = $e(t, this.socket.binaryType), this.onPacket(t)
    }
...
const He = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), Ue = 64, We = {};
let Ve, Ye = 0, Xe = 0;

function Ke(t) {
    let e = "";
    for (; e = He[t % Ue] + e, 0 < (t = Math.floor(t / Ue));) ;
    return e
}
...
class nr extends je {
    ...
    create() {
        ...
        try {
            ...
            try {
                if (this.opts.extraHeaders) for (var r in e.setDisableHeaderCheck && e.setDisableHeaderCheck(!0), this.opts.extraHeaders) this.opts.extraHeaders.hasOwnProperty(r) && e.setRequestHeader(r, this.opts.extraHeaders[r])
            } catch (t) {
            }
...
if (nr.requestsCount = 0, nr.requests = {}, "undefined" != typeof document) if ("function" == typeof attachEvent) attachEvent("onunload", or); else if ("function" == typeof addEventListener) {
...
const cr = {
        websocket: class extends Ge {
            ...
            uri() {
                var t = this.query || {}, e = this.opts.secure ? "wss" : "ws";
                let r = "";
            ...
            uri() {
                var t = this.query || {}, e = this.opts.secure ? "https" : "http";
                let r = "";
            ...
            request(t = {}) {
                return Object.assign(t, {xd: this.xd, xs: this.xs}, this.opts), new nr(this.uri(), t)
            }

            doWrite(t, e) {
                (t = this.request({method: "POST", data: t})).on("success", e), t.on("error", ((t, e) => {
...
let dr = class t extends je {
    ...
    open() {
        let e;
        if (this.opts.rememberUpgrade && t.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket")) e = "websocket"; else {
    ...
    probe(e) {
        let r = this.createTransport(e), s = !1;
        t.priorWebsocketSuccess = !1;
        const n = () => {
            s || (r.send([{type: "ping", data: "probe"}]), r.once("packet", (e => {
                s || ("pong" === e.type && "probe" === e.data ? (this.upgrading = !0, this.emitReserved("upgrading", r), r && (t.priorWebsocketSuccess = "websocket" === r.name, this.transport.pause((() => {
                    s || "closed" !== this.readyState && (h(), this.setTransport(r), r.send([{type: "upgrade"}]), this.emitReserved("upgrade", r), r = null, this.upgrading = !1, this.flush())
...
function wr(t, e) {
    if (t && "object" == typeof t) if (Array.isArray(t)) {
        ...
        for (const e in t) if (Object.prototype.hasOwnProperty.call(t, e) && wr(t[e])) return !0
    }
    return !1
}
...
function xr(t) {
    var e = [], r = t.data;
    return t.data = kr(r, e), t.attachments = e.length, {packet: t, buffers: e}
}
...
function Cr(t, e) {
    if (t) {
        ...
        if (Array.isArray(t)) for (let r = 0; r < t.length; r++) t[r] = Cr(t[r], e); else if ("object" == typeof t) for (const r in t) Object.prototype.hasOwnProperty.call(t, r) && (t[r] = Cr(t[r], e))
    }
    return t
}
...
var Pr = Object.freeze({
    __proto__: null, Decoder: Or, Encoder: class {
        constructor(t) {
            this.replacer = t
        }
...
class Tr extends je {
    ...
    subEvents() {
        var t;
        this.subs || (t = this.io, this.subs = [Rr(t, "open", this.onopen.bind(this)), Rr(t, "packet", this.onpacket.bind(this)), Rr(t, "error", this.onerror.bind(this)), Rr(t, "close", this.onclose.bind(this))])
    }
    ...
    emit(t, ...e) {
        if ($r.hasOwnProperty(t)) throw new Error('"' + t.toString() + '" is a reserved event name');
        var r, s;
    ...
    _registerAckCallback(t, e) {
        ...
        if (void 0 === r) this.acks[t] = e; else {
    ...
    emitEvent(t) {
        if (this._anyListeners && this._anyListeners.length) for (const e of this._anyListeners.slice()) e.apply(this, t);
    ...
    disconnect() {
        return this.connected && this.packet({type: xt.DISCONNECT}), this.destroy(), this.connected && this.onclose("io client disconnect"), this
    }
    ...
    offAnyOutgoing(t) {
        if (this._anyOutgoingListeners) if (t) {
    ...
    notifyOutgoingListeners(t) {
        if (this._anyOutgoingListeners && this._anyOutgoingListeners.length) for (const e of this._anyOutgoingListeners.slice()) e.apply(this, t.data)
    }
}
...
class Lr extends je {
    ...
    open(t) {
        if (!~this._readyState.indexOf("open")) {
            ...
            const s = this.engine, n = this,
                o = (this._readyState = "opening", this.skipReconnect = !1, Rr(s, "open", (function () {
                    n.onopen(), t && t()
                })));
            var e = Rr(s, "error", (e => {
    ...
    onopen() {
        ...
        var t = this.engine;
        this.subs.push(Rr(t, "ping", this.onping.bind(this)), Rr(t, "data", this.ondata.bind(this)), Rr(t, "error", this.onerror.bind(this)), Rr(t, "close", this.onclose.bind(this)), Rr(this.decoder, "decoded", this.ondecoded.bind(this)))
    }
...
function Nr(t, e) {
    ...
    var r = t.source, s = t.id, n = t.path;
...
const qr = t => {
    ...
    Fr = st("<div>"), Gr = st('<div class="w-full h-32">'), Hr = "Hi there! How can I help?", Ur = t => {
        let e, r, s;
        const [n, o] = x(""), [i, a] = x(!1), [l, c] = x(!1), [h, u] = x({}), [p, d] = x([{
            message: t.welcomeMessage ?? Hr,
            type: "apiMessage"
        }], {equals: !1}), [f, g] = x(""), [b, y] = x(!1), m = (A((() => {
            r && setTimeout((() => {
            ...
            d((e => [...e.map(((r, s) => s === e.length - 1 ? {...r, message: r.message + t} : r))]))
        }, w = t => {
            d((e => [...e.map(((r, s) => s === e.length - 1 ? {...r, sourceDocuments: t} : r))]))
        }, S = async e => {
            if (o(e), "" !== e.trim()) {
                a(!0), d((t => [...t, {message: e, type: "userMessage"}])), m();
                var r, s = {question: e, history: p().filter((e => e.message !== t.welcomeMessage ?? Hr))};
                t.chatflowConfig && (s.overrideConfig = t.chatflowConfig), b() && (s.socketIOClientId = f());
                const {data: n, error: i} = await Rt({chatflowid: t.chatflowid, apiHost: t.apiHost, body: s});
                n && ("object" == typeof n && n.text && n.sourceDocuments ? b() || d((t => [...t, {
                    message: n.text,
                    sourceDocuments: n.sourceDocuments,
                    type: "apiMessage"
                }])) : b() || d((t => [...t, {
                    message: n,
                    type: "apiMessage"
                }])), a(!1), o(""), m()), i && (console.error(i), s = i.response.data || i.response.status + ": " + i.response.statusText, r = s, d((t => [...t, {
                    message: r,
                    type: "apiMessage"
                }])), a(!1), o(""), m())
            }
        ...
        return _((() => {
            ...
            var e = (await (({chatflowid: t, apiHost: e = "http://localhost:3000"}) => St({
                method: "GET",
                url: e + "/api/v1/chatflows-streaming/" + t
            }))({chatflowid: t.chatflowid, apiHost: t.apiHost})).data;
            e && y(e?.isStreaming ?? !1);
            ...
            return r.on("connect", (() => {
                ...
                o(""), a(!1), d([{message: t.welcomeMessage ?? Hr, type: "apiMessage"}]), r && (r.disconnect(), g(""))
            }
        })), [(() => {
            const o = Dr(), a = o.firstChild, l = a.firstChild;
            var h;
        ...
        var e, r
    }, Vr = st("<style>"), Yr = st('<div part="bot">'), Xr = t => {
        const [e] = V(t, ["theme"]), [r, s] = x(!1), [n, o] = x(!1);
        var i;
        return [(ct(i = Vr(), kt), i), F(Pt, W((() => e.theme?.button), {
            toggleBot: () => {
                r() ? s(!1) : (n() || o(!0), s(!0))
            }, get isBotOpened() {
                return r()
            ...
            }), {_v$: void 0, _v$2: void 0, _v$3: void 0, _v$4: void 0}), s
        })()]
    }, Kr = st("<style>"), Jr = st("<div>"), Qr = (t, {element: e}) => {
        ...
        return A((() => {
            ...
            get when() {
                ...
                const e = Jr();
                return e.style.setProperty("height", "85vh"), e.style.setProperty("margin", "0px"), ct(e, F(Ur, {
                    get badgeBackgroundColor() {
                ...
                })), k((() => null != (t.theme?.chatWindow?.backgroundColor || "#ffffff") ? e.style.setProperty("background-color", t.theme?.chatWindow?.backgroundColor || "#ffffff") : e.style.removeProperty("background-color"))), e
            }
        })];
        var o
    }, Zr = t => {
