...
class News(models.Model):
    title_ru = models.CharField(max_length=255, verbose_name=_('titleRu'))
    title_kz = models.CharField(max_length=255, verbose_name=_('titleKz'))
    title_en = models.CharField(max_length=255, verbose_name=_('titleEn'))
